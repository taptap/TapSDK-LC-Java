...
import com.tapsdk.lc.ops.AddOperation;
import com.tapsdk.lc.ops.BaseOperation;
import com.tapsdk.lc.ops.BitAndOperation;
import com.tapsdk.lc.ops.SetOperation;
...
public class ArchivedRequestsTest extends TestCase {
  ...
  public void testSaveEventuallyWithoutNetwork() throws Exception {
    ...
    LCObject obj2 = LCObject.createWithoutData("Something", "5ee898df4d498f00068da1f6");
